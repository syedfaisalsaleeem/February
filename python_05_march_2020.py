...
class exportallresults(QWidget):
    ...
    def InitUI(self):
        ...
        self.label.setGeometry(410,20,300,50)


        self.etd = QPushButton('Export All Tabular Data', self)
        self.etd.setGeometry(120,170,300,80)
...
"padding: 4px; color: black")
        ...
        self.eag.setGeometry(120,320,300,80)
...
"padding: 4px; color: black")
        ...
        self.etp.setGeometry(120,470,300,80)
...
"padding: 4px; color: black")
        ...
        self.save.setGeometry(540,170,300,80)
...
"padding: 4px; color: black")
        ...
        self.save.setGeometry(540,320,300,80)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.save.setGeometry(540,470,300,80)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.back.setGeometry(700,70,200,60)
...
class point3calibration(QWidget):
    ...
    def InitUI(self):
        ...
        self.p1.setGeometry(150,105,270,50)


        self.e_p1 = extQLineEdit1(self)
        self.e_p1 .setFont(QFont('Arial', 18))
        self.e_p1 .setGeometry(397,105,300,63)
        ...
        self.label_deg_c2.move(710, 220)
        ...
        self.p2.setGeometry(150,205,270,50)


        self.e_p2 = extQLineEdit1(self)
        self.e_p2 .setFont(QFont('Arial', 18))
        self.e_p2 .setGeometry(397,205,300,63)
        ...
        self.label_deg_c3.move(710, 320)
        ...
        self.p3.setGeometry(150,305,270,50)


        self.e_p3 = extQLineEdit1(self)
        self.e_p3 .setFont(QFont('Arial', 18))
        self.e_p3 .setGeometry(397,305,300,63)
...
"padding: 4px; color: black")
    ...
    def call_first1(self):
         ...
         self.userswindow.show()
class point2calibration(QWidget):
    ...
    def InitUI(self):
        ...
        self.save = QPushButton('Start Calibration', self)
        self.save.setGeometry(395,305,300,70)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
    ...
    def call_first1(self):
         ...
         self.userswindow=calibrationscreen(self.mainwindow)
         self.userswindow.show()
class point1calibration(QWidget):
    ...
    def InitUI(self):
        ...
        self.sc.setGeometry(395,205,300,70)
...
"padding: 4px; color: black")
        ...
        self.back = QPushButton('Back', self)
        self.back.setGeometry(395,305,300,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class masterpasswordscreen(QWidget):
    ...
    def InitUI(self):
        ...
        self.nsp.setGeometry(90,120,270,50)
        ...
        self.cp.setGeometry(90,240,270,50)


        self.e_nsp = extQLineEdit1(self)
        self.e_nsp .setFont(QFont('Arial', 18))
        self.e_nsp .setGeometry(390,120,500,53)
        ...
        self.e_nsp.setEchoMode(QtGui.QLineEdit.Password)
        ...
        self.e_cp.setGeometry(390,240,500,53)
        ...
        self.e_cp.setEchoMode(QtGui.QLineEdit.Password)
        ...
        self.save.setGeometry(450,335,300,70)
        self.save.setFont(QFont('Arial', 21))
        self.save.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
"padding: 4px; color: black")
        ...
        self.back = QPushButton('Back', self)
        self.back.setGeometry(450,435,300,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class servicepassword_screen():
    ...
    newservicepassword=''
    confirmservicepassword=''
class servicepasswordscreen(QWidget):
    ...
    def InitUI(self):
        ...
        self.lcp.setGeometry(90,120,270,50)
        ...
        self.lnp.setGeometry(90,240,270,50)
        ...
        self.lcnp.setGeometry(90,360,270,50)

        self.e_cp = extQLineEdit1(self)
        self.e_cp .setFont(QFont('Arial', 18))
        self.e_cp .setGeometry(390,120,500,53)
        self.e_cp .setStyleSheet('background-color:white; color: black')
        ...
        self.e_np.setGeometry(390,240,500,53)
        ...
        self.e_np.setEchoMode(QtGui.QLineEdit.Password)
...
class performance(QWidget):
    ...
    def InitUI(self):
        ...
        self.tth1.move(400,340)
        self.tth1.setText(str(self.halted))

        self.back = QPushButton('Back', self)
        self.back.setGeometry(700,130,240,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class calibrationscreen(QWidget):
    ...
    def InitUI(self):
        ...
        self.label.setFont(QFont('Arial', 21))
        self.label.setStyleSheet('background-color:white; color: black')
        self.label.setGeometry(460,20,220,50)
    
        self.c1 = QPushButton('1 Point Calibration', self)
        self.c1 .setGeometry(390,85,300,120)
...
"padding: 4px; color: black")
        ...
        self.c2 .setGeometry(390,230,300,120)
...
"padding: 4px; color: black")
        ...
        self.c3.setGeometry(390,380,300,120)
...
"padding: 4px; color: black")
        ...
        self.back = QPushButton('Back', self)
        self.back.setGeometry(400,535,300,70)
        self.back.setFont(QFont('Arial', 21))
        self.back.setStyleSheet("background-color:#4299ff;border: none;border-style: outset;\n"
"font: 14pt \"Arial\";\n"
"border-width: 1px;\n"
...
class testing(QWidget):
    ...
    def InitUI(self):
        ...
        self.ins_settings.setGeometry(370,100,285,125)
...
"padding: 4px; color: black")
        ...
        self.service.setGeometry(370,300,285,125)
...
class notification1(QWidget):
    ...
    def InitUI(self):
        ...
        self.b_power.setGeometry(370,100,285,125)
...
"padding: 4px; color: black")
        ...
        self.b_alarm.setGeometry(370,300,285,125)
...
"padding: 4px; color: black")
    ...
    def call_first1(self):
        ...
        gc.collect()
        self.mainwindow.show()
class selecttemperaturelimit(QWidget):
    def __init__(self,mainwindow):
    #def __init__(self,name):
        super().__init__()
        self.title = "App"
...
"padding: 4px; color: black")
    ...
    def call_save(self):
        ...
        #self.userswindow=startwindow(self.mainwindowshow)
       #self.userswindow.show()
class selectscreentimeout(QWidget):
    def __init__(self,mainwindow):
    #def __init__(self,name):
        super().__init__()
        self.title = "App"
...
class servicepasswordwindow(QWidget):
        #def __init__(self, parent=None):
        #super(AnalogGaugeWidget, self).__init__(parent)
    def __init__(self,mainwindow):
       #parent=None
...
class running_window(QWidget):
    ...
    def InitUI(self):
        ...
        self.n.setGeometry(800,530,50,50)
        ...
        self.s.setGeometry(715,530,80,50)
...
class subwindow2(QMainWindow):
    ...
    def InitUI(self):
        ...
        timer.timeout.connect(self.updateTime)
        timer.start(100)
        self.mySubwindow=subwindow(self)
...
# padding: 4px; color: black''')
    ...
    def buttonWindow1_onClick(self):
        ...
        #gc.collect()
        self.rgwindow = startwindow(self)
        #self.setCentralWidget(self.rgwindow)
        self.rgwindow.show()
    def settingswindow(self):
        self.close()
        #self.destroy()
