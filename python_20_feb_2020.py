...
"padding: 4px; color: black")
    ...
    def retranslateUi(self):
        ...
        self.comboBox_2.setItemText(0, _translate("self", "FAST"))
        self.comboBox_2.setItemText(1, _translate("self", "MEDIUM"))
        self.comboBox_2.setItemText(2, _translate("self", "SLOW"))
